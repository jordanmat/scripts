...
# Array of known clusters with their domains
declare -A clusters
clusters["bet99-prod"]="bet99-prod.route53.abetting.co"
clusters["bet99-ontario-prod"]="bet99-ontario-prod.route53.abetting.co"
clusters["betjets-prod"]="betjets-prod.route53.abetting.co"
clusters["coral-prod"]="coral-prod.route53.abetting.co"
clusters["fitzdares-prod"]="fitzdares-prod.route53.abetting.co"
clusters["fitzdares-uk-prod"]="fitzdares-uk-prod.route53.abetting.co"
clusters["flutter-prod"]="flutter-prod.route53.abetting.co"
clusters["lulabet-prod"]="lulabet-prod.route53.abetting.co"
clusters["saracen-ar-prod"]="saracen-ar-prod.route53.abetting.co"
clusters["saracen-prod"]="saracen-prod.route53.abetting.co"
clusters["shin-prod"]="shin-prod.route53.abetting.co"
clusters["tote-prod"]="tote-prod.route53.abetting.co"
clusters["bet99-stg"]="bet99-stg.route53.abetting.co"
clusters["bet99-uat"]="bet99-uat.route53.abetting.co"
clusters["coral-dev"]="coral-dev.route53.abetting.co"
clusters["amelco-dev8"]="amelco-dev8.route53.abetting.co"
clusters["amelco-dev9"]="amelco-dev9.route53.abetting.co"
clusters["amelco-uat4"]="amelco-uat4.route53.abetting.co"
clusters["amelco-uat8"]="amelco-uat8.route53.abetting.co"
clusters["amelco-uat9"]="amelco-uat9.route53.abetting.co"
clusters["amelco-stage"]="amelco-stage.route53.abetting.co"
clusters["bet99-dev"]="bet99-dev.route53.abetting.co"
...
grep -E $'\t8[0-9]\.[0-9]{2}%|\t9[0-9]\.[0-9]{2}%|\t100\.00%' "$output_file" || echo "None found"
